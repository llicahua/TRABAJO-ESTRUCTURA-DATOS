...
public class EjemploRepaso {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            int numero = JOptionPane.showConfirmDialog(null, "Realmente desea salir ?", "Confirmar salida", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        ...
        for (i = 0; i < nombres.length; i++) {
            ...
            try {
                ...
                nombres[i] = (JOptionPane.showInputDialog("No me diste un nombre,"
